...
const SiteModel: Model = {
  ...
  dynamodb: {
    pk: (site: { id: string }): string => `SITE#${site.id}`,
    sk: (site: { id: string }): string => `SITE#${site.id}`,
    gsi1pk: (site: { ownerId: string }): string => `OWNER#${site.ownerId}`,
    gsi1sk: (site: { id: string }): string => `SITE#${site.id}`,
  },
}
