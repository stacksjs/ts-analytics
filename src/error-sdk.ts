...
export function generateErrorSdk(): string {
  ...
  var TSA={
    ...
    captureMessage:function(msg,level){send({message:String(msg),type:'Message',level:level||'info',url:location.href,environment:cfg.environment,release:cfg.release,tags:{},user:null,extra:{},sdkVersion:'tsa-sdk/1'});}
  };
  g.TSA=TSA;
})(window);`
}
